        ...
        <div @click.away="open = false" class="flex flex-col flex-shrink-0 w-full md:w-64  text-gray-200 bg-gray-800 md:fixed md:h-full " x-data="{ open: false }">
            <div class="flex flex-row items-center justify-between flex-shrink-0 px-8 py-4">
                ...
                <nav :class="{'block': open, 'hidden': !open}" class="flex-grow px-4 pb-4 md:block md:pb-0 md:overflow-y-auto">
                     ...
                     <x-admin-nav-link :href="route('admin.categories.index')" :active="request()->routeIs('admin.categories.index')" class="flex items-center justify-between">
                        {{ __('Categories') }}
                     ...
                     <x-admin-nav-link :href="route('admin.products.index')" :active="request()->routeIs('admin.products.index')" class="flex items-center justify-between">
                           {{ __('Products') }}
