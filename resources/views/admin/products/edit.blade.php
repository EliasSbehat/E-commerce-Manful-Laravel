...
<form action="{{route('admin.products.update' , $product->id)}}" method="POST" enctype="multipart/form-data">
 ...
 <div class="mb-6">
  ...
  <textarea name="description" id="" cols="30" rows="5" value="{{$product->description}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-lg focus:ring-gray-400  focus:border-gray-400  block w-1/2"></textarea>
 </div>
